...
/**
 * All the validation methods and method to take screenshot are defined in this class.
 * 
 * @author dieuph
 */
public class Assertion {
	...
	public Assertion(WebDriver driver) {
		file = new File("");
		screenshotDir = file.getAbsoluteFile() + "//screenshots";
		this.driver = driver;
	}
	...
	public String screenShot() {
		String screenshotPath = "screenshot" + new SimpleDateFormat("MM-dd-yyyy-HH-mm-ss").format(new GregorianCalendar().getTime()) + ".png";

		System.out.println(screenshotPath);
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		
		try {
			FileUtils.copyFile(scrFile, new File(screenshotDir + screenshotPath));
		} catch (IOException e) {
			e.printStackTrace();
			screenshotPath = "";
		}
	...
	public void screenShot(String message) {
		String screenshotPath = message + "screenshot" + new SimpleDateFormat("MM-dd-yyyy-HH-mm-ss").format(new GregorianCalendar().getTime()) + ".png";
	...
	public boolean verifyEquals(Object actual, Object expected, String message, boolean screenshotOnFailure, boolean exitOnFailure) {
		...
		try {
			...
			if (screenshotOnFailure) {
				Reporter.log("<Font Color=red> FAIL </Font> " + message + " Actual: " + actual + " Expected: " + expected + " Please check the screenshot " + "<a href='" + screenShot() + "'> <Font Color=red> here </Font> </a>");
			}
	...
	public boolean verifyTrue(boolean condition, String message, boolean screenshotOnFailure, boolean exitOnFailure) {
		...
		try {
			...
			if (screenshotOnFailure) {
				Reporter.log("<Font Color=red> FAIL </Font> " + message + " Actual: FALSE Expected: TRUE." + " Please check the screenshot " + "<a href='" + screenShot() + "'> <Font Color=red> here </Font> </a>");
			} else {
